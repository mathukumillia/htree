...
public class BracketWindow extends JFrame implements MouseListener {
	
	private Bracket tree = null;
	 ...
	 */
	public BracketWindow(int width, int height) {
		super("BracketWindow");
	...
	private void reset() {
		...
		if (tree == null) { // tree not created yet
			tree = new Bracket(b.width / 2, b.height / 2 + 12, 
	...
	public static void main(String[] args) {
		BracketWindow htwin = new BracketWindow(600, 520);
